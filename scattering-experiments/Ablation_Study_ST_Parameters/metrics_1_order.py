...
def Calculate_Metrics_1_order(folder_name, augmentation_flag):
...
Folder_Names = ['VARIA_P_100_M1_J10_Q8', 'VARIA_P_100_M1_J10_Q6', 'VARIA_P_100_M1_J10_Q4']
for folder_name in Results_Folders_Names:
    #if folder_name[12:14]=='M1':
    if folder_name in Folder_Names:
        if folder_name[-12:]=='augmentation':
            agumentation_flag = True
        else:
            agumentation_flag = False
        if folder_name == 'VARIA_P_100_M1_J10_Q12_augmentation':
            continue
        elif folder_name == 'VARIA_P_100_M1_J10_Q14_augmentation':
            continue
        else:
            ...
            Names = folder_name
            Metrics = Calculate_Metrics_1_order(folder_name,augmentation_flag=agumentation_flag)
            Results = {'Names': Names, 'Metrics': Metrics}

            with open(Tests_directory + '/Results_' + folder_name  + '.pkl', 'wb') as fp:
